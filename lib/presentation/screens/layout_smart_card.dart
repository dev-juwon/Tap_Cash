...
class LayoutSmartCardScreen extends StatelessWidget {
  const LayoutSmartCardScreen({Key? key}) : super(key: key);
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text(cubit.smartCardTitles[cubit.currentIndex]),
            centerTitle: true,
          ...
          body: cubit.smartCardScreens[cubit.currentIndex],
        );
      },
    );
  }
